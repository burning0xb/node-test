...
class ProductEdit extends Component {
  ...
  static propTypes = {
    ...
    clearuser: React.PropTypes.func.isRequired,
    clearpass: React.PropTypes.func.isRequired,
  };
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.user.user.status !== undefined) {
      this.setState({ status: nextProps.user.user.status });
    }
  }
  ...
  render() {
    return (
      <div>
        ...
        <div className="dyh4">
                	<span className="biaoti">编辑用户</span>
				...
				<div className="yhoxx">
                    <div className="yh_jiben">
                        ...
                        <div className="yh_jb_dw">
                            <div className="gg_xx">
                                <div className="gg_xx_l"><span className="txx">用户ID：</span><span className="zjbjj" style={{ fontFamily: 'Helvetica' }}><input data-info="no" ref="userId" type="text" readOnly value={this.props.user.user.userId}/></span></div>
                            </div>
                            <div className="gg_xx">
                                  <div className="gg_xx_l"><span className="txx">用户名：</span><span className="zjbjj" style={{ fontFamily: 'Helvetica' }}><input type="text" data-info="password" ref="username" value={this.props.user.user.name} /><i className="error"></i></span></div>
                                <div className="gg_xx_r"><span className="czz" onClick={this.user.bind(this)}>重置</span></div>
                            </div>
                            <div className="gg_xx">
                                <div className="gg_xx_l"><span className="txx">密码：</span><span className="zjbjj"><input data-info="password" onClick={this.password.bind(this)} type="password" value={this.props.user.user.password} ref="password"/><i className="error"></i></span></div>
                                <div className="gg_xx_r"><span className="czz" onClick={this.password.bind(this)}>重置</span></div>
                            </div>
                            <div className="gg_xx">
                                <div className="gg_xx_l"><span className="txx">密码尝试次数：</span><span className="zjbjj" style={{ fontFamily: 'Helvetica' }}><input data-info="no" type="num" ref="pwdTries" value={this.props.user.user.pwdTries} /></span></div>
                            </div>
